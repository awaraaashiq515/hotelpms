...
2. For each item:
   ...
   - "desc": Clean description. If multiple prices exist, specify details (e.g. "Half: 40 / Full: 75"). Otherwise leave empty.
...
try:
    print("Calling Qwen with hierarchical compact JSON...")
