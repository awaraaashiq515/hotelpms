...
prompt = f"""
Convert the raw OCR text from a menu image into a category-grouped list.
Format each item strictly as: Item Name | Price | Description

Raw OCR Text:
{raw_ocr_text}

Instructions:
1. Category start: "# Category Name".
2. Items format: Name | Price | Description
3. Clean names: Remove slashes, numbers, "@" symbols. E.g. "Bombay Cold Sandwich @40/@75" -> "Bombay Cold Sandwich".
4. Multi-price: Set "Price" to base price, "Description" to other prices (e.g. "Half: 40 / Full: 75").
"""
...
try:
    print("Calling Qwen with no timeout...")
