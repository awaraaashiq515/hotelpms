      ...
      <html>
        ...
        <body onload="window.print(); setTimeout(() => window.close(), 1000);">
          <div class="text-center font-bold">
            <h1 style="font-size: 24px; margin-bottom: 1mm; letter-spacing: -0.5px;">${invoice.property?.name || 'GUESTFLOW POS'}</h1>
    ...
    <div className="space-y-6 py-4">
      ...
      <div className="flex justify-between items-start">
        <div className="space-y-1">
          ...
          <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight uppercase">{invoice.property?.name || 'GuestFlow POS'}</h2>
