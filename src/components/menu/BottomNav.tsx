...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab, orderCount = 0 }) => {
  const tabs = [
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="relative flex flex-col items-center justify-center w-16 h-16 group transition-all"
            >
              ...
              <span className={`text-[9px] font-black uppercase tracking-[0.15em] mt-1.5 transition-all ${
