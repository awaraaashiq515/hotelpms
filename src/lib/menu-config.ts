...
export const getSidebarMenu = (role: string): MenuItem[] => {
  ...
  return [
    ...
    { name: 'Categories',  path: '/categories',icon: Layers,    feature: 'POS',       roles: ['RESTAURANTS_ADMIN', 'SUPER_ADMIN', 'POSSYSTEM'], perm: 'Inventory' },
    { name: 'KOTs',        path: '/kots',      icon: Layers,    feature: 'POS' },
    { name: 'Kitchen Display', path: '/kitchen-display', icon: Eye, feature: 'POS' },
    { name: 'Day Closing', path: '/day-closing', icon: Layers,  feature: 'POS',       roles: ['RESTAURANTS_ADMIN', 'SUPER_ADMIN', 'POSSYSTEM'], perm: 'Day Closing' },
    {
      name: 'Expenses',
      path: '/expenses',
      icon: TrendingDown,
    ...
    },
    {
      ...
      icon: Layers,
      subItems: [
        { name: 'Table Layout',    path: '/operations/tables',    feature: 'TABLES' },
        ...
        { name: 'Table Bookings',  path: '/table-reservations',   feature: 'TABLES' },
