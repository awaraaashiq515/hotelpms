    ...
    <div className="space-y-10 pb-10">
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
           <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Reports & Intelligence</h1>
           <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-1">Real-time business performance analytics</p>
        </div>
      </div>
