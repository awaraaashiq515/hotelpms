...
export default function BarPosPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      } catch { addToast('error', 'Failed to load Bar POS data'); }
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '9px', flexShrink: 0 }}>
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: 800, color: '#E8A838', letterSpacing: '0.06em', lineHeight: 1 }}>BAR POS</div>
              <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.2)', letterSpacing: '0.14em', textTransform: 'uppercase', marginTop: '2px' }}>Premium Bar</div>
            </div>
          </div>
          ...
          <div style={{ flex: 1, maxWidth: '400px', position: 'relative' }}>
            ...
            <input
              type="text" placeholder="Search drinks, spirits..."
          ...
          <button onClick={() => router.push('/billing')} style={{
            ...
            letterSpacing: '0.04em', cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.15s',
          }}
