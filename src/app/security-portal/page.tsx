...
export default async function SecurityPortalIndexPage() {
  ...
  if (firstProp?.code) {
    redirect(`/security-portal/${firstProp.code.toLowerCase()}`)
  }
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 20, fontWeight: 900, margin: 0 }}>No Properties Found</h1>
