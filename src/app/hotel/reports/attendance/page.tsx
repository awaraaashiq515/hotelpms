  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/hotel/staff"
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-bold transition-all shadow-sm group"
        >
        ...
        <Link
          href="/hotel"
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800/60 hover:bg-slate-700 border border-slate-700/70 text-slate-400 hover:text-white text-xs font-bold transition-all"
        >
      ...
      <div className="flex justify-end gap-3 flex-wrap">
        <Link 
          href={`${basePrefix}/staff/attendance-location`}
        ...
        <Link 
          href={`${basePrefix}/staff/location`}
