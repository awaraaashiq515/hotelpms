  ...
  return (
    <div className="space-y-6">
                ...
                <tr key={exp.id} className={`border-b border-gray-50 dark:border-slate-700 hover:bg-gray-50/30 dark:hover:bg-slate-800/30 transition-colors group ${exp.status === 'VOID' ? 'opacity-50' : ''}`}>
                  ...
                  <td className="px-4 py-3.5">
                    <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                      {exp.voucherId && (
                        <Link href="/hotel/vouchers" className="p-1.5 text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-950 rounded-lg" title="View Voucher">
      ...
      <div className="flex gap-3">
        <Link href="/hotel/vouchers" className="px-5 py-2.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 hover:border-violet-300 hover:text-violet-600 rounded-xl text-xs font-bold tracking-widest transition-all">
          View Vouchers →
        </Link>
      </div>
    </div>
